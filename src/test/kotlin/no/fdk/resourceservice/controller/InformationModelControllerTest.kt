...
class InformationModelControllerTest : BaseControllerTest() {
    ...
    fun `should get information model graph by id`() {
        ...
        every { rdfService.convertFromJsonLd(graphData, RdfService.RdfFormat.JSON_LD, RdfService.RdfFormatStyle.PRETTY, false) } returns """{"@id":"https://example.com/information-model","title":"Test Information Model"}"""
