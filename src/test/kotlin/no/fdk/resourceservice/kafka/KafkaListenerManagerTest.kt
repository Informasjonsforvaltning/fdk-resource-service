...
class KafkaListenerManagerTest {
    ...
    fun setUp() {
        ...
        val circuitBreakerNames = listOf(
            "rdfParseConsumer", "conceptConsumer", "datasetConsumer", 
            "dataServiceConsumer", "informationModelConsumer", 
            "serviceConsumer", "eventConsumer"
        )
