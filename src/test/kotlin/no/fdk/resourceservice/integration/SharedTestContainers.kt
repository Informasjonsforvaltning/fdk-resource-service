...
object SharedTestContainers {
    ...
    val schemaRegistryContainer: GenericContainer<*> = GenericContainer("confluentinc/cp-schema-registry:7.4.0")
        .withNetwork(network)
    ...
    fun getAllContainers(): List<org.testcontainers.containers.Container<*>> {
        return listOf(postgresContainer, kafkaContainer, schemaRegistryContainer)
    }
