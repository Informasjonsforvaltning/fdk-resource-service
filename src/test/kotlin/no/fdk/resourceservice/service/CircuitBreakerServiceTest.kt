...
class CircuitBreakerServiceTest {
    ...
    fun `should handle DatasetEvent successfully`() {
        ...
        verify { resourceService.storeResourceGraphData("test-dataset-id", ResourceType.DATASET, any(), any(), any()) }
    }
    ...
    fun `should handle DataServiceEvent successfully`() {
        ...
        verify { resourceService.storeResourceGraphData("test-dataservice-id", ResourceType.DATA_SERVICE, any(), any(), any()) }
    }
    ...
    fun `should handle InformationModelEvent successfully`() {
        ...
        verify { resourceService.storeResourceGraphData("test-informationmodel-id", ResourceType.INFORMATION_MODEL, any(), any(), any()) }
    }
    ...
    fun `should handle ServiceEvent successfully`() {
        ...
        verify { resourceService.storeResourceGraphData("test-service-id", ResourceType.SERVICE, any(), any(), any()) }
    }
    ...
    fun `should handle EventEvent successfully`() {
        ...
        verify { resourceService.storeResourceGraphData("test-event-id", ResourceType.EVENT, any(), any(), any()) }
    }
    ...
    fun `should trigger fallback when ResourceService throws exception in handleConceptEvent`() {
        ...
        // When ResourceService throws an exception
        every { resourceService.storeResourceGraphData(any(), any(), any(), any(), any()) } throws
