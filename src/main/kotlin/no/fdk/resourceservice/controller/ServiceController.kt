...
class ServiceController(
    ...
    fun getServiceGraph(
        ...
        return handleGraphRequest(id, ResourceType.SERVICE, acceptHeader, rdfFormatStyle, expandUris ?: false)
    }
    ...
    fun getServiceGraphByUri(
        ...
        return handleGraphRequestByUri(uri, ResourceType.SERVICE, acceptHeader, rdfFormatStyle, expandUris ?: false)
    }
